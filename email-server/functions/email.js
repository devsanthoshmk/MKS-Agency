...
const templates = {
    ...
    <body>
      <div class="container">
        <div class="card">
          ...
          <div class="footer">
            <p>MKS AGENCY | Siddha & Ayurveda Medicines</p>
    ...
    <body>
      <div class="container">
        <div class="card">
          ...
          <p class="footer">This link expires in 24 hours.<br>MKS AGENCY | Siddha & Ayurveda Medicines</p>
        </div>
      </div>
    </body>
    </html>
  ...
  emailLogin: (data) => `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Sign In to MKS AGENCY</title>
      <style>
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background-color: #f5f5f4; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .card { background: white; border-radius: 16px; padding: 32px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); text-align: center; }
    ...
    <body>
      <div class="container">
        <div class="card">
          ...
          <p>Click the button below to securely sign in to MKS AGENCY. No password needed!</p>
          ...
          <p class="footer">If you didn't request this, you can safely ignore this email.<br>MKS AGENCY | Siddha & Ayurveda Medicines</p>
        </div>
      </div>
    </body>
    </html>
    ...
    if (event.httpMethod === 'POST') {
      ...
      if (path === '/send/order-confirmation') {
        ...
        await transporter.sendMail({
          from: `"MKS AGENCY" <${process.env.GMAIL_USER}>`,
          to,
      ...
      if (path === '/send/admin-alert') {
        ...
        await transporter.sendMail({
          from: `"MKS AGENCY System" <${process.env.GMAIL_USER}>`,
          to: adminEmail,
      ...
      if (path === '/send/guest-verification') {
        ...
        await transporter.sendMail({
          from: `"MKS AGENCY" <${process.env.GMAIL_USER}>`,
          to,
          subject: 'Verify Your Email - MKS AGENCY',
